...
/**
 * default module
 * Table definition for 'blocks/media'
 *
...
$zz['title'] = 'Media for Blocks';
$zz['table'] = '/*_PREFIX_*/blocks_media';

$zz['fields'][1]['title'] = 'ID';
$zz['fields'][1]['field_name'] = 'block_medium_id';
$zz['fields'][1]['type'] = 'id';

$zz['fields'][2]['title'] = 'Block';
$zz['fields'][2]['field_name'] = 'block_id';
$zz['fields'][2]['type'] = 'select';
$zz['fields'][2]['sql'] = 'SELECT block_id, title, identifier
	FROM /*_PREFIX_*/blocks
	ORDER BY identifier';
$zz['fields'][2]['display_field'] = 'title';
$zz['fields'][2]['search'] = '/*_PREFIX_*/blocks.title';
...
$zz['subselect']['sql'] = 'SELECT block_id, filename, version
		, t_mime.extension AS thumb_extension
		, o_mime.extension
	FROM /*_PREFIX_*/blocks_media
	...
	AND /*_PREFIX_*/blocks_media.sequence = 1
';
$zz['subselect']['image'] = $zz['fields'][5]['path'];

$zz['sql'] = 'SELECT /*_PREFIX_*/blocks_media.*
	, /*_PREFIX_*/blocks.title AS block
	, CONCAT("[", /*_PREFIX_*/media.medium_id, "] ", /*_PREFIX_*/media.title) AS image
	...
	LEFT JOIN /*_PREFIX_*/filetypes AS t_mime
		ON /*_PREFIX_*/media.thumb_filetype_id = t_mime.filetype_id
';
$zz['sqlorder'] = ' ORDER BY /*_PREFIX_*/blocks.title, sequence';
